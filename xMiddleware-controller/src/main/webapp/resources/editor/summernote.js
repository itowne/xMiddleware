    ...
    VideoDialog.prototype.initialize = function () {
        var $container = this.options.dialogsInBody ? this.$body : this.$editor;
         var body = [
            ...
            '<label class="note-form-label">请选择视频</label>',
            '<select id="dvoSelect" class="note-video-url form-control note-form-control">',
            	vdos,
            '</select>',
            '</div>'
        ].join('');
        var buttonClass = 'btn btn-primary note-btn note-btn-primary note-video-btn';
        var footer = "<button type=\"submit\" href=\"#\" class=\"" + buttonClass + "\" >插入视频</button>";
        this.$dialog = this.ui.dialog({
...
//              .attr('allowtransparency', 'true')
                .attr('src', ctx+"/vdo/vdoShow/"+url)
                .attr('width', '600').attr('height', '230');
//    	$video = $$1('<video controls  preload="none">')
//    			.attr("poster",ctx+"/resources/images/play.jpeg")
//  				.attr("x5-video-player-type","h5")
//  				.attr("x5-video-player-fullscreen","true")
//  				.attr("webkit-playsinline","true")
//  				.attr("playsinline","true")
//  				//.attr("x5-video-ignore-metadata","true")
//              .attr('src', ctx+"/upload/vdo/"+url)
//              .attr('width', '600').attr('height', '360');
    ...
    VideoDialog.prototype.showVideoDialog = function (text) {
        ...
        return $$1.Deferred(function (deferred) {
            ...
            _this.ui.onDialogShown(_this.$dialog, function () {
                _this.context.triggerEvent('dialog.shown');
                $videoUrl.on('select', function () {
                    _this.ui.toggleBtn($videoBtn, $videoUrl.val());
                });
                if (!env.isSupportTouch) {
                    $videoUrl.parent().trigger('focus');
                }
