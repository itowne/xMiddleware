...
<body class="nav-md">
												...
												<form id="demo-form2"
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" name="vdoName" id="vdoName" value="${vdo.vdoName}" class="form-control col-md-7 col-xs-12" maxlength="20"/>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3 col-sm-3 col-xs-12"
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<video controls="controls" width="100%" src="${ctx}/upload/vdo/${vdo.sysFileName}"></video>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3 col-sm-3 col-xs-12">选择视频</label>
														<div class="col-md-6 col-sm-6 col-xs-12">
	...
	<script type="text/javascript">
		...
		function doSubmit() {
			...
			var vdoId='${vdo.vdoId}';
			fd.append("vdoId",vdoId);
			$.ajax({
				type : "POST",
				url : "${ctx}/vdo/doEditVdo",
				async:false,
				cache: false,
				contentType: false,
				processData: false,
				...
				success :function (data){
					if(data==undefined||data==""){
						xAlert("提示","修改视频失败","error");
						return;
					}
					var res = eval('(' + data + ')'); 
					if(res.resCode!=1){
						xAlert("提示","修改视频失败! "+res.resMsg,"error");
						return;
					}
					xAlert("提示","修改视频成功","success");
					setTimeout(function(){
						window.location.href="${ctx}/vdo/index";
					},3000)
				} , 
				error :function (XMLHttpRequest, textStatus, errorThrown){
					xAlert("提示","修改视频失败! 请稍后再试","error");
				},
