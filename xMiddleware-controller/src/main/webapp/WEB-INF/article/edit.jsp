...
<body class="nav-md">
                    ...
                    <form id="bizForm" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="title" class="form-control col-md-7 col-xs-12" value="${article.title}">
                        </div>
                      </div>
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="author" class="form-control col-md-7 col-xs-12" value="${article.author}"/>
                        </div>
                      </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <select id="voteSelect" name="voteId" class="form-control">
                          </select>
                        </div>
                      </div>
                       <div class="form-group">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#sidebar-menu #art-li").addClass("current-page");
  			...
  			initEdit();
			initDaterangepicker();
			$("#edt").val('${article.endTimeLabel}');
			$("#stt").val('${article.startTimeLabel}');
		});
	...
	function initDaterangepicker(){
		...
		function doEdit(){
			...
			$("#sContent").val($('#summernote').summernote('code'));
			$.ajax({
				type : "POST",
				url : "${ctx}/article/doEditArticle",
				dataType : "json",
				async:false,
		...
		function initEdit(){
			initVote();
			initImg();
			var voteId = '${article.voteId}';
			var imgId = '${article.imgId}';
			var isTop = '${article.isTop}';
			$("#voteSelect").val(voteId);
			$("#imgSelect").val(imgId);
			$("#isTop").val(isTop);
			var content = '${article.content}';
			$('#summernote').summernote('code',_.unescape(content));
		}
		function checkForm(){
			if($("#title").val()==""){
