												...
												<div class="x_content">
													...
													<form id="demo-form2" class="form-horizontal form-label-left">
														<div class="form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">登录名<span class="required">*</span> </label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input type="text" name="loginName" id="loginName" class="form-control col-md-7 col-xs-12" maxlength="20" />
															</div>
														</div>
														<div class="form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">姓名<span class="required">*</span> </label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input type="text" name="realName" id="realName" class="form-control col-md-7 col-xs-12" maxlength="20" />
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input type="password" name="pwd" id="pwd" class="form-control col-md-7 col-xs-12">
															</div>
														</div>
														<c:if test="${isAdmin=='1'}">
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input class="form-control col-md-7 col-xs-12" type="text" name="mobile" id="mobile" maxlength="11" />
															</div>
														</div>
														<div class="ln_solid"></div>
														<div class="form-group">
															<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
																<button type="button" class="btn btn-success" onclick="doSubmit()">新增</button>
				...
				$.ajax({
					...
					success: function(data) {
						if(data == undefined || data == "") {
							xAlert("提示", "新增用户失败", "error");
							return;
						}
						if(data.resCode != 1) {
							xAlert("提示", "新增用户失败! " + data.resMsg, "error");
							return;
						}
						xAlert("提示", "新增用户成功", "success");
						setTimeout(function() {
							window.location.href = "${ctx}/user/index";
						}, 3000)
					},
					error: function(XMLHttpRequest, textStatus, errorThrown) {
						xAlert("提示", "新增用户失败! 请稍后再试", "error");
					},
