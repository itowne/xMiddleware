												...
												<form id="demo-form2"
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" name="imgName" id="imgName" autocomplete="off" class="form-control col-md-7 col-xs-12" maxlength="20"/>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-md-3 col-sm-3 col-xs-12">选择图片<span class="required">*</span></label>
														<div class="col-md-6 col-sm-6 col-xs-12">
			...
			$.ajax({
				...
				success :function (data){
					if(data==undefined||data==""){
						xAlert("提示","新增图片失败","error");
						return;
					}
					var res = eval('(' + data + ')'); 
					if(res.resCode!=1){
						xAlert("提示","新增图片失败! "+res.resMsg,"error");
						return;
					}
					xAlert("提示","新增图片成功","success");
					setTimeout(function(){
						window.location.href="${ctx}/img/index";
					},3000)
				} , 
				error :function (XMLHttpRequest, textStatus, errorThrown){
					xAlert("提示","新增图片失败! 请稍后再试","error");
				},
