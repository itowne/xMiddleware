										...
										<div class="weui-cells weui-cells_form">
											<div class="weui-cell">
												<div class="weui-cell__hd">
													<label class="weui-label"><span class="n-sp">*</span>姓名</label>
												</div>
												<div class="weui-cell__bd">
													<input class="weui-input" type="text" name="applyName"
														id="applyName" maxlength="15" placeholder="请输入姓名" />
												</div>
											</div>
											<div class="weui-cell">
												<div class="weui-cell__hd">
												...
												<div class="weui-cell__bd">
													<input class="weui-input" maxlength="11" type="text"
														name="mobile" id="mobile" placeholder="请输入手机号" />
												</div>
											</div>
										</div>
									</section>
		...
		<div class="weui-dialog">
			...
			<div class="weui-dialog__ft">
				<a href="javascript:void(0);"
					...
					onclick="konwClose('iosDialog2')">确定</a>
			</div>
		</div>
	</div>
